...
.docskin .funnel-label{font-family:var(--font-display);font-size:12.5px;font-weight:700;fill:var(--white);text-anchor:middle;}
.docskin .funnel-val{font-family:var(--font-mono);font-size:11px;fill:var(--white);text-anchor:middle;opacity:.9;}
