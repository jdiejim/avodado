...
.docskin .cp-gate{flex:1 1 130px;min-width:120px;background:var(--light-blue);border:1px solid var(--rule);border-radius:var(--radius);padding:12px 14px;}
.docskin .cp-gate-label{font-family:var(--font-display);font-weight:700;font-size:14px;color:var(--navy);}
.docskin .cp-desc{font-size:12px;color:var(--slate);margin-top:5px;line-height:1.45;}
.docskin .cp-op,.docskin .cp-eq{align-self:center;font-family:var(--font-mono);font-size:20px;font-weight:700;color:var(--gray);padding:0 10px;}
.docskin .cp-result{flex:1 1 130px;min-width:120px;background:var(--positive-soft);border:1px solid var(--positive);border-radius:var(--radius);padding:12px 14px;}
.docskin .cp-result-kicker{font-size:9px;text-transform:uppercase;letter-spacing:.1em;font-weight:700;color:var(--positive);margin-bottom:4px;}
.docskin .cp-result-label{font-family:var(--font-display);font-weight:700;font-size:14px;color:var(--charcoal);}`;
