...
.docskin .cp-gate{flex:1 1 150px;min-width:140px;background:var(--white);border:1px solid var(--rule);border-top:3px solid var(--navy);border-radius:8px;padding:0 0 12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.05);display:flex;flex-direction:column;}
...
.docskin .cp-result{flex:1 1 150px;min-width:140px;align-self:stretch;background:var(--positive-soft);border:1px solid var(--positive);border-radius:8px;padding:14px;display:flex;flex-direction:column;justify-content:center;}
...
.docskin .dv-card{border:1px solid var(--rule);border-top:3px solid var(--navy);border-radius:8px;background:var(--white);padding:18px 16px;text-align:center;box-shadow:0 1px 4px rgba(0,0,0,.05);}
...
.docskin .op-card{border:1px solid var(--rule);border-radius:8px;background:var(--white);overflow:hidden;display:flex;flex-direction:column;}
...
.docskin .st-item{border:1px solid var(--rule);border-radius:8px;background:var(--white);overflow:hidden;}
...
.docskin .pattern{margin:22px 0;border:1px solid var(--rule);border-radius:10px;background:var(--white);overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.05);}
...
.docskin .gl-card{border:1px solid var(--rule);border-radius:8px;background:var(--white);overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.05);display:flex;flex-direction:column;min-width:0;}
.docskin .gl-card>.code-header{border-radius:0;}
.docskin .gl-card>pre{margin:0;border:none;border-radius:0;font-size:11.5px;line-height:1.5;flex:1;}
