...
rows:
  ...
  - ["avo catalog [-s]", "A catalog of every block — identifier, what it does, and a live sample (-s for slides)"]
  - ["avo design [slug]", "Grab a design-pattern template (system design + GoF); --all renders the gallery"]
