...
description: >-
  ...
  wireframe · endpoint · pullquote · layers).
...
4. **Pick 2-5 blocks that carry the structure.** Don't try to use all 44 in one doc.
...
types, and don't reach for all 44. Start from the doc's job and pick a stack:
...
- The info-string is exactly one of the **44 block types** listed below — never
  invent new ones.
