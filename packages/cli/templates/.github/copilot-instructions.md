...
— installed as the **`avodado-docs`** skill and at `.avodado/skill/SKILL.md`. It
defines the block grammar and the `doc#id` reference scheme; every block's full
field contract lives beside it in `.avodado/skill/reference/`.
