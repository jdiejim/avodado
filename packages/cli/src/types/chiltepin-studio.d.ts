/**
 * Ambient contract for the optional `chiltepin-studio` package.
 *
 * `chiltepin studio` imports it lazily at runtime (and degrades gracefully when the
 ...
 * keep it in sync with `chiltepin-studio`'s public API.
 */
declare module 'chiltepin-studio' {
