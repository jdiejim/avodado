...
```
avo theme               # interactive picker — built-ins + your saved custom themes
avo theme list          # list built-in + saved custom themes
avo theme new sunset    # scaffold a new custom theme in .avodado/themes/sunset.theme.json
avo theme use sunset    # activate a built-in or saved theme  (shorthand: avo theme sunset)
avo theme use dark      # built-ins: textbook|minimal|soft|dark|teal|plum|slate
avo theme custom        # scaffold a blank custom theme straight into avodado.theme.json
