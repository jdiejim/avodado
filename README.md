...
- `.avodado/skill/SKILL.md` — the authoring skill (block grammar + worked examples for all 44 blocks)
...
| Package | Purpose |
| --- | --- |
| [`@avodado/core`](./packages/core) | Parser, Zod block schemas (all 44 types), validation, reference resolver. Pure (no I/O). |
