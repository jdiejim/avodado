...
avo design                            # list design patterns (system design + GoF code patterns)
avo design strategy                   # print a ready `pattern` template to adapt (copies to clipboard)
avo design strategy -o docs/x.md      # …or scaffold it into a doc
avo design --all [--system|--code] [-s]   # render the whole pattern gallery (sample HTML / slides)
