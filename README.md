...
Full list: **[84 block types](#the-84-block-types)** across 12 families.
...
- **`.avodado/skill/SKILL.md`** — the authoring skill: the full block grammar with a worked example for all 84 blocks.
...
| Business & strategy | `swot` `okr` `persona` `wardley` |
...
| Package | Purpose |
| --- | --- |
| [`@avodado/core`](./packages/core) | Parser, Zod block schemas (all 84 types + 12 permanent aliases), validation, reference resolver. Pure — no I/O. |
