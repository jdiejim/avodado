...
Avodado is a documentation-as-code system. A four-package monorepo where dependencies always point inward toward a pure `@avodado/core`. **37 block types** ported from `resources/doc-studio.jsx`, each with a zod schema, a typed renderer entry, and (where applicable) shared layout / SVG utilities.
